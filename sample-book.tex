...
% * added page background color (out commented)
...
% Uncomment the following three lines if you want to add a page background color
%\usepackage{pagecolor}
%\definecolor{LightChamois}{HTML}{FFFFF3}
...
\begin{lstlisting}[name=Quicksort]
...
\begin{docspec}
  ...
  \qquad \textbackslash setfloatalignment\{b\}\% forces caption to be bottom-aligned\\
...
\begin{docspec}
  ...
  \qquad \textbackslash caption\{This is an example of a sine wave.\}\\
  \qquad \textbackslash label\{fig:sinewave\}\\
  \qquad \textbackslash forceversofloat\% forces caption to be set to the left of the float\\
  \textbackslash end\{figure\}
\end{docspec}
\end{fullwidth}
